...
namespace SystemIntegrated.Repositorio
{
    public class GrupoProdutoRepositorio
    {
        ...
        public List<GrupoProdutoViewModel> RecuperarLista(int pagina = 0, int tamPag = 0, string filtro = "")
        {
            var ret = new List<GrupoProdutoViewModel>();
                                                                   ...
                                                                   ), con))
            {
                ...
                while (reader.Read())
                {
                    ret.Add(new GrupoProdutoViewModel()
                    {
                        Id =(int) reader["Id"],
        ...
        public int RecuperarQuantidade()
        {
            ...
            using(SqlCommand command = new SqlCommand("SELECT COUNT(*) FROM GrupoProduto", con))
            {
                con.Open();
        ...
        public bool ExcluirPeloId(int id)
        {
            ...
            using(SqlCommand command = new SqlCommand(" DELETE GrupoProduto " +
                                                      "  WHERE Id=@Id       ", con))
            {
                con.Open();
